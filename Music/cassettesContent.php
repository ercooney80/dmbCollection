...
<form action="removeItems.php" method="POST">
  <?php if ($superUser): ?>
    ...
    <table>
      ...
      <th style="width: 20%"><a href="displayTable.php?table=cassettes&type=Music&orderField=title">Title</a></th>
      <th style="width: 4%"><a href="displayTable.php?table=cassettes&type=Music&orderField=tapes">Tapes</a></th>
      <th style="width: 9%"><a href="displayTable.php?table=cassettes&type=Music&orderField=country">Country</a></th>
