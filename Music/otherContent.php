...
<form action="removeItems.php" method="GET">
    ...
    <table>
        ...
        <?php foreach ($list as $cassette): ?>
            <tr>
                <td><?php if ($superUser): ?>
                        <input type="checkbox" name="ids[]" value="<?php echo htmlspecialchars($cassette['id']) ?>" />
                        <a href="modifyCassette.php?id=<?php echo $cassette['id'] ?>"><?php echo htmlspecialchars($cassette['artist']); ?></a>                       
                <?php else: ?>
                        <?php echo htmlspecialchars($cassette['artist']); ?>   
                    </td><?php endif; ?>
