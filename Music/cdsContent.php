...
<form action="removeItems.php" method="POST">
  <?php if ($superUser): ?>
    ...
    <table>
      ...
      <th style="width: 19%"><a href="cds.php?orderField=title">Title</a></th>
      <th style="width: 6%"><a href="cds.php?orderField=discs">Discs</a></th>
      <th style="width: 8%"><a href="cds.php?orderField=country">Country</a></th>
  ...
  <?php else: ?>
    <table>
      <th style="width: 12%"><a href="displayTable.php?table=cds&type=Music&orderField=artist">Artist</a></th>
      <th style="width: 20%"><a href="displayTable.php?table=cds&type=Music&orderField=title">Title</a></th>
      <th style="width: 4%"><a href="displayTable.php?table=cds&type=Music&orderField=discs">Discs</a></th>
      <th style="width: 9%"><a href="displayTable.php?table=cds&type=Music&orderField=country">Country</a></th>
      <th style="width: 7%"><a href="displayTable.php?table=cds&type=Music&orderField=cond">Condition</a></th>                    
      <th style="width: 4%"><a href="displayTable.php?table=cds&type=Music&orderField=prod_year">Year</a></th>
      <th style="width: 10%"><a href="displayTable.php?table=cds&type=Music&orderField=upc">UPC/CAT#</a></th>                             
      <th style="width: 10%"><a href="displayTable.php?table=cds&type=Music&orderField=category">Category</a></th>
      <th style="width: 24%">Description</th>
      <?php foreach ($list as $cd): ?>
        <tr>     
          <td><?php echo htmlspecialchars($cd['artist']); ?></td>
          <td><?php echo htmlspecialchars($cd['title']); ?></td>
          <td style="text-align: center;"><?php echo htmlspecialchars($cd['discs']); ?></td>
          <td><?php echo htmlspecialchars($cd['country']); ?></td>
          <td><?php echo htmlspecialchars($cd['condition']); ?></td>
